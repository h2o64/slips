...
# Run the experiment
def run_exp(n_langevin_steps_range, device, batch_size, target, dim, score_est, score_type, sigma, alpha, K, T, epsilon, epsilon_end):
...
if __name__ == "__main__":
	...
	# Run the experiment
	results = run_exp(n_langevin_steps_range, device, args.batch_size, target, args.dim, score_est, score_type, sigma, alpha, args.K, T, args.epsilon, epsilon_end)
